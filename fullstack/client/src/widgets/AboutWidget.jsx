...
const AboutWidget = (props) => {
    const { username, Department, contactNumber, handle, password, position, eventsCovered} = props.profileInfo;  
        ...
        <div className="text-gray-700">
            <div className="grid md:grid-cols-2 text-sm">
                ...
                <div className="grid grid-cols-2">
                    ...
                    <div className="px-4 py-2"><a href={`https://instagram.com/${handle}`}>@{handle}</a></div>
                </div>
                <div className="grid grid-cols-2">
                ...
                <div className="grid grid-cols-2">
                    ...
                    <div className="px-4 py-2">{eventsCovered}</div>
                </div>
                <div className="grid grid-cols-2">
